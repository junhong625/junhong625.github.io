...
그리고 이 포스팅은 DB에 관해 공부한 것들을 정리하며 다시 한 번 복습하고 블로그에 기록하는 습관을 들이기 위한 저의 첫번째 기록입니다.
...
### DBMS의 종류
DBMS에도 종류가 있는데 대표적으로 사용되는 DBMS는 *RDBMS(관계형 데이터베이스)*와 *NoSQL(비관계형 데이터베이스)*이 있습니다.
